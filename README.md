...
supports the same services (`inference`, `iri`, `globus-compute`) and mirrors
the Python CLI argument format: `<action> [<service>]`, with the service passed
positionally and no options.
